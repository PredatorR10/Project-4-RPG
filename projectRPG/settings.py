"""
Django settings for projectRPG project.
...
SECRET_KEY = 'django-insecure-vi@mpj+m&q0jq@!r0cma+*i88wn1inf4^4c9rl!-j!h$_g@4t%'
...
WSGI_APPLICATION = 'projectRPG.wsgi.application'
